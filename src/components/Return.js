            ...
            <div>
                ...
                <div className="return-mobule-2">
                    ...
                    <div style={{width:"100%",overflow:"hidden"}}>
                        <div style={{marginLeft:"100%"}} id="return-dynamicEffect-2" className="return-info">
                            <div></div>
                            <p>Returns must be requested within 30 days from the date of purchase.</p>
                            <div></div>
                            ...
                            <div></div>
                            <p>Returns are not accepted for customized products, or for any item that has been damaged due to misuse or customer-induced physical damage.</p>
                            <div></div>
                ...
                <div className="return-mobule-3">
                    <h3>Return Process</h3>
                    <div className="return-process-info">
                        <div className="return-process-text">
                            To request a return via email, please contact us at <a style={{color:"black"}} href="mailto:service@proceast.com">service@proceast.com</a>. <br /><br />In your email, include the email address used to place the order or the order number, the reason for the return, and clear pictures showing the condition of the product.
                        </div>
                        <img className="return-process-right-img" src={require("../assets/images/right.png")} alt="right" />
                        <div className="return-process-text">
