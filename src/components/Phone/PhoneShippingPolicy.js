...
import "../../assets/css/phone/phoneShippingPolicy.css";
class PhoneShippingPolicy extends Component {
    constructor(props) {
        super(props);
        this.state = { 
                ...
                <div className="Pshipping-policy-mobule">
                    ...
                    <div className="Pshipping-info-mobule">
                        ...
                        <div className="Pshipping-text-mobule">
                            ...
                            <p>
                                Upon receiving your goods, please promptly inspect them for integrity and quantity. If you discover any damage, shortages, or other issues, please contact our after-sales service team immediately at <a style={{color:"black"}} href="mailto:after-sales@jendey.com">after-sales@jendey.com</a>.
                            </p>
                        </div>
                        <div className="Pshipping-text-mobule">
                            <h4>Other</h4>
                            <p>
                            We are committed to providing you with efficient and reliable shipping services. If you have any questions or needs, please feel free to contact us. Once again, thank you for choosing the Jendey brand!
                            </p>
                        </div>
                    </div>
                </div>
...
export default PhoneShippingPolicy;