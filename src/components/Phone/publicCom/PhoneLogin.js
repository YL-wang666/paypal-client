...
sendForm=()=>{
    ...
    render() {
        return (
            <div className="PLoginForm" >
                
                <h2 className="Psign-logo">Jendey</h2>
                <hr />
                
                <div style={this.state.logStatus ? {} : {display:"none"}} className="Psign-logged-mobule">
                ...
                <div style={this.state.logStatus ? {display:"none"} : {}}>
                    <div className="PSignUpFormText">
                        <h2 className="Psign-title">Login</h2>
                        <div>
                            <label>Account:</label><br />
                            <input id="loginUserName" className="PSignUpInput" onBlur={this.checkEmail} placeholder="Email address"></input><br />
                            <span id="loginState" className="PSignUpState">{this.state.signUpMessage}</span>
                        </div>
                        <div>
                            <label>Password:</label><br />
                            <input id="loginPassWord" className="PSignUpInput" type="password" maxLength="30" placeholder="Password"></input><br />
                            <span id="passwordState" >{this.state.passwordMessage}</span>
                        </div>
                    </div>
                    <div>
                        <input id="loginSubmit" className="PSignUpSubmit" onClick={this.sendForm} type="button" value="Login" />
                    ...
                    <div className="Plogin-link-mobule">
