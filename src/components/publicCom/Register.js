            ...
            <form className="SignUpForm" >
                    ...
                    <div className="SignUpFormText">
                        <div className="sign-title-mobule">
                            ...
                            <div className="sign-link-text"><i onClick={this.openLogin}> Login </i></div>
                        </div>
                        <div>
                            <label>Account:</label><br />
                            <input id="SignUpUsername" className="SignUpInput" onBlur={this.checkEmail} placeholder="Email address"></input><br />
                            <span id="SignUpState" className="SignUpState">{this.state.signUpMessage}</span>
                        </div>
                        <div className="SignUpVerify">
                            <label>Verify Email:</label><br />
                            <input id="SignUpCaptcha" className="SignUpCaptcha" placeholder="verification code" maxLength="6"></input>
                            {
                        ...
                        <div style={{marginTop:"2%"}}>
                            <div>
                                ...
                                <input id="SignUpPassword" className="SignUpPassword" type="password" maxLength="30" placeholder="password" onFocus={this.checkPassword} onBlur={this.checkPassword}/><br />
                            </div>
                            <div style={{marginTop:"3%"}}>
                                <label>Confirm Password:</label><span style={{color: "red",fontSize: "14px",marginLeft: "10px"}}>{this.state.passwordSecond}</span><br />
                                <input id="SignUpSecondPassword" className="SignUpConfirm" type="password" maxLength="30" placeholder="Please confirm your password" onBlur={this.confirmPassword} />
                            </div>
                        </div>
                    </div>
                    <div>
                        <input id="SignUpSubmit" className="SignUpSubmit" onClick={this.sendForm} type="button" value="Subscribe Now" ></input>
