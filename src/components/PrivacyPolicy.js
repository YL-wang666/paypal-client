   ...
   pageLoadAdd=()=>{
    ...
    render() {
        return (
            ...
            <div style={{width:"100%",backgroundColor:"whitesmoke",height:"30px"}}></div>
            <div style={{width:"80%",marginLeft:"5%",marginBottom:"10%"}}>
                <div></div>
                <h3 style={{fontSize:"35px",width:"100%",marginLeft:"15%",marginTop:"20%",fontWeight:"500",fontFamily:"'Noto Serif SC', serif"}}>Privacy Policy</h3>
                
                <p style={{lineHeight:"30px",width:"80%",marginLeft:"15%",marginTop:"5%",letterSpacing:"0.6px"}}>
                    
                    <b>Introduction</b>
                    <br /><br />
                    Welcome to PorcEast. We highly value your privacy and are committed to protecting your personal information. This privacy policy is designed to help you understand how we collect, use, and protect your personal information. Please read this privacy policy carefully before using this site.
                    <br /><br />
                    ...
                    <b>Contact Us</b>
                    <br /><br />
                    If you have any questions or concerns about this privacy policy or your personal information, please contact us via email at service@porceast.com
                </p>
            </div>
