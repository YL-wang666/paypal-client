...
class BlogsInfo extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <div>
                ...
                <div className="blogs-text-mobule">
                    ...
                    <div className="blogs-product-mobule">
                        <div>
                            <div className="blog_info-directory-title">Related Article</div>
                            <div className="blog_info-directory-mobule">
                                {
                        ...
                        <div style={{marginTop:"10%"}} className="blogs-product-info">
                            <div style={this.state.nowPro.off === ""?{display:"none"}:{}} className="blogs-product-off-label">${this.state.nowPro.off} OFF</div>
                            ...
                            <div className="blogs-product-func">{this.state.nowPro.func}</div>
